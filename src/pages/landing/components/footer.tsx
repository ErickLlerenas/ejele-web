...
import { APP_STORE_COMING_SOON, APP_STORE_URL, PLAY_STORE_URL } from '@/constants/store';
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-3 mb-6">
              <li>
                <a href="#platforms" className="text-gray-400 hover:text-white transition-colors text-sm font-medium flex items-center gap-2 no-underline">
