  ...
  const features = [
    {
      ...
      title: "Comandero",
      description:
        "Toma y administra comandas desde la computadora principal. Se envían a cocina.",
      color: "blue",
      premium: false,
    },
    {
    ...
    },
    {
      ...
      title: "100% Offline",
      description:
        "Opera sin internet. Todo se guarda localmente en tu computadora.",
      color: "orange",
      premium: false,
    },
    {
    ...
    },
    {
      ...
      title: "Inventario",
      description:
        "Registra entradas, salidas por venta y ajustes de productos.",
      color: "pink",
      premium: true,
    },
    {
    ...
    },
    {
      ...
      description:
        "Cortes completos y precisos. Genera reportes y cierra turnos rápido.",
      color: "emerald",
      premium: false,
    },
    {
      ...
      description:
        "Guarda información de contacto, domicilio e historial de pedidos.",
      color: "rose",
      premium: false,
    },
    {
      ...
      description:
        "Control por perfiles. Autorización vía PIN para operaciones sensibles.",
      color: "violet",
      premium: false,
    },
  ];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className={`p-6 rounded-lg ${cardBgColors[feature.color as keyof typeof cardBgColors]} reveal transition-all hover:scale-[1.02] relative`}
              >
                {feature.premium && (
                ...
                <div
                  className={`w-12 h-12 rounded-lg ${iconBgColors[feature.color as keyof typeof iconBgColors]} flex items-center justify-center mb-4`}
                >
                  <Icon
                    icon={feature.icon}
                    className={`${iconColors[feature.color as keyof typeof iconColors]} w-6 h-6`}
                  />
                </div>
